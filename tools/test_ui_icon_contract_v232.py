...
assert 'VqeafIcons::draw(tft, expected, iconX, iconY, 36' in ui
assert 'VqeafIcons::draw(tft, id, iconX, r.y + 6, 36' in ui
assert 'VqeafIcons::draw(tft, standardId, 12, y + 9, 24' in ui
