...
records=[
 ...
 ('2026-09-25T01:00:10+00:00','[VQEAF][CLOCK] target_mhz=240 observed_mhz=240 uptime_ms=10000'),
...
with tempfile.TemporaryDirectory() as td:
    ...
    assert result['cpu_samples']==1 and result['observed_cpu_mhz_min']==240
    assert (out/'clock_windows.csv').exists()
