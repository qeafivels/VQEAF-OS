...
extern uint32_t gWifiFakeMs; inline uint32_t millis(){return gWifiFakeMs;} inline void delay(uint32_t){} inline void pinMode(int,int){} inline int digitalRead(int){return HIGH;} inline void digitalWrite(int,int){} inline void analogWrite(int,int){}
